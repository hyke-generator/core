...
const statefulComponentGenerator: TemplateGenerator<IComponentGeneratorArgs> = buildTemplateGenerator<
    IComponentGeneratorArgs
>({
    outputDirectory: "./src/components",
    fileExtension: "tsx",
    templatePath: "core/templates/StatefulComponent.mustache",
});
